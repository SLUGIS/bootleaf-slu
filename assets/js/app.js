var map, battalionSearch = [], stationSearch = [];
...
/* Battalion .geojson from https://github.com/SLUGIS/Battalions and simplified with http://www.mapshaper.org/ to 10% */
var battalions = L.geoJson(null, {
...
$.getJSON("data/battalions_slu.json", function (data) {
  battalions.addData(data);
});
...
map = L.map("map", {
  zoom: 10,
  center: [35.3, -120.5],
  layers: [mapquestOSM, battalions, markerClusters],
  zoomControl: false,
...
attributionControl.onAdd = function (map) {
  ...
  div.innerHTML = "Developed by <a href='http://slocountyfire.org'>SLO County Fire</a> | <a href='#' onclick='$(\"#attributionModal\").modal(\"show\"); return false;'>Attribution</a>";
  return div;
};
...
$(document).one("ajaxStop", function () {
  /* Fit map to battalions bounds */
  map.fitBounds(battalions.getBounds());
  $("#loading").hide();

  var battalionsBH = new Bloodhound({
    name: "Battalions",
    datumTokenizer: function (d) {
      return Bloodhound.tokenizers.whitespace(d.name);
    },
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    local: battalionSearch,
    limit: 10
  });
  ...
  $("#searchbox").typeahead({
    ...
    name: "Battalions",
    displayKey: "name",
    source: battalionsBH.ttAdapter(),
    templates: {
      header: "<h4 class='typeahead-header'>Battalions</h4>"
    }
  }, {
    name: "Stations",
    displayKey: "name",
